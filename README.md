...
Secrets stay in a `0600` `.env`, never in the Compose file; passwords are
generated with `crypto/rand`; Docker commands use argument arrays (no shell
injection); releases are signed with cosign and ship an SBOM. Details in the
[security model](docs/security.md). To report a vulnerability, see
[SECURITY.md](SECURITY.md).

## Contributing

Contributions are welcome, especially new [recipes](docs/recipes.md). See
[CONTRIBUTING.md](CONTRIBUTING.md) and the
[Code of Conduct](CODE_OF_CONDUCT.md).

## License

[MIT](LICENSE) © Amr Elsagaei
